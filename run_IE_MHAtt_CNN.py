...
from pytorch_pretrained_bert.modeling import BertConfig, IE_MHAtt_CNN
...
def main():
    ...
    model = IE_MHAtt_CNN.from_pretrained(args.bert_model,
                                                          cache_dir=cache_dir,
    ...
    if args.do_train:
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            eval_model = IE_MHAtt_CNN.from_pretrained(args.bert_model, state_dict=model_state_dict, num_labels=num_labels,max_turn_num = args.max_utterance_num)
        ...
        model_state_dict = torch.load(output_model_file)
        model = IE_MHAtt_CNN.from_pretrained(args.bert_model, state_dict=model_state_dict,
